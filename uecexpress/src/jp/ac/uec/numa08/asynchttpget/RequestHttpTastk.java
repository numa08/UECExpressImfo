...
public class RequestHttpTastk extends AsyncTask<String, Void, String> {
	private static final String TAG = RequestHttpTastk.class.getSimpleName();
	 ...
	 * @param listener
	 */
	public RequestHttpTastk(final Activity activity,
	...
	protected void onPreExecute() {
		...
		this.dialog.setOnCancelListener(new OnCancelListener() {
			...
			public void onCancel(final DialogInterface dialog) {
				// TODO Auto-generated method stub
				RequestHttpTastk.this.cancel(true);
			}
		});
		this.dialog.show();
	}
